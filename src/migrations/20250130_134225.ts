...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_roles" AS ENUM('superadmin', 'admin', 'developer', 'writer', 'eventmgr', 'user');
  ...
  CREATE TYPE "public"."enum_courses_render_style" AS ENUM('style-1', 'style-2', 'style-3');
  CREATE TYPE "public"."enum_courses_course_format" AS ENUM('short', 'medium', 'long');
  ...
  CREATE TABLE IF NOT EXISTS "courses_f_a_qs" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "courses" (
  	...
  	"image_id" integer,
  	"difficulty_level" "enum_courses_difficulty_level",
  	"render_style" "enum_courses_render_style",
  	"course_format" "enum_courses_course_format",
  ...
  DO $$ BEGIN
   ALTER TABLE "categories" ADD CONSTRAINT "categories_card_id_programs_id_fk" FOREIGN KEY ("card_id") REFERENCES "public"."programs"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "courses_f_a_qs" ADD CONSTRAINT "courses_f_a_qs_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."courses"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "categories_card_idx" ON "categories" USING btree ("card_id");
  CREATE INDEX IF NOT EXISTS "categories_parent_idx" ON "categories" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "categories_updated_at_idx" ON "categories" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "categories_created_at_idx" ON "categories" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "programs_updated_at_idx" ON "programs" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "programs_created_at_idx" ON "programs" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "courses_f_a_qs_order_idx" ON "courses_f_a_qs" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "courses_f_a_qs_parent_id_idx" ON "courses_f_a_qs" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "courses_modules_order_idx" ON "courses_modules" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "courses_modules_parent_id_idx" ON "courses_modules" USING btree ("_parent_id");
  ...
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_programs_id_idx" ON "payload_locked_documents_rels" USING btree ("programs_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "courses_f_a_qs" CASCADE;
  ...
  DROP TYPE "public"."enum_courses_render_style";
  DROP TYPE "public"."enum_courses_course_format";
