...
import { placeholderImg, scan } from '../../_assets/images'

export default function WhatsppCommunity({whatsappLink,whatsappQrCode}) {
  return (
    <div className="bgImg flex justify-between  gap-20 mx-10 p-8 bg-primary-100 rounded-xl max-lg:mx-4 max-lg:p-4 mt-10 max-sm:mt-5">
      <div className="space-y-8">
        <div className="space-y-2 max-lg:text-center">
          ...
          <Link href={`${whatsappLink ? whatsappLink : "#"}`} aria-label="whtspp" className="text-primary-400 text-lg font-semibold text-nowrap hidden max-lg:block py-4">
      ...
      <div className="flex flex-col gap-2 pt-4 max-lg:hidden">
        <div className="w-full aspect-[1/1] relative rounded-lg ring-1 ring-green-400">
          <Image fill src='/whatsApp.jpg' alt="incorrect img path" className="rounded-lg" sizes='148px' loading='lazy' />
        </div>
        <Link
          href="https://chat.whatsapp.com/Hg2Q0X2pZOu6Wiu81yxfKW"
          aria-label="whtspp"
          target='_blank'
