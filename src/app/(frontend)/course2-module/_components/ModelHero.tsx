...
import HeroVideo from '../../course-1/_component/HeroSection/HeroVideo'
                ...
                <div className='flex container max-lg:flex-col max-lg:items-center max-lg:text-center mx-auto justify-center gap-10 padding-x padding-y'>
                    <div className='space-y-10 max-xl:space-y-6 pt-10 max-lg:pt-0'>
                        ...
                        <div className=' space-x-10 max-xl:space-x-6 space-y-6 max-xs:space-y-4 max-lg:text-wrap lg:text-nowrap mx-auto my-auto'>
                            <Button className='p-6 text-lg max-xl:text-base max-xl:p-4 max-sm:text-sm font-semibold hover:bg-primary-400 shadow-[6px_6px_0px_hsl(var(--primary-400))] hover:shadow-[5px_5px_0px_hsl(var(--primary-500))]'>Click here to Enroll <ChevronsRight strokeWidth={4} /></Button>
