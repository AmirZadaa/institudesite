...
const Enroll = () => {
  return (
    <div className='bg-gradient-to-r from-blue-700 to-blue-950'>
                ...
                <div className="lg:w-[50%] lg:h-[432px] flex flex-col justify-center items-center gap-7 px-4">                 
                    ...
                    <div className='flex flex-col lg:flow-row items-center gap-3 w-full'>
                        <div className="w-full lg:w-[60%] p-5 bg-card rounded-xl">
                            <input type="tel"  maxLength={13} autoComplete="tel" pattern="03[0-9]{2}-[0-9]{7}" inputMode="tel" placeholder="03XX-XXXXXXX" className="text-black w-full outline-none" />
                        </div>
                        <button className="w-full lg:w-[40%] bg-yellow-500 text-black cursor-pointer p-5 rounded-xl">
