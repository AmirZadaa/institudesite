    ...
    <>
        <div className="container mx-auto  mt-20  py-4 px-4">
            <div className="animate-slide-btt text-center my-4">
                ...
                <p className="text-[12px] lg:text-[14px] font-medium text-gray-700 mt-2">
            ...
            <div className='flex flex-col lg:flex-row lg:flex-wrap justify-center mt-8 items-center gap-4 lg:gap-0'>
            {
                PreparationBox().map((item) => (
                    <>           
                            <div key={item.id} className="animate-slide-ltr lg:w-[24%] h-[300px] lg:h-[400px] bg-white border-2 cursor-pointer  rounded-xl border-background mb-2 lg:mb-4 p-3 lg:p-4 lg:ml-12">
                                <div className=" flex flex-col items-center justify-between text-center gap-3 lg:gap-6">
                                    ...
                                    <p className="text-gray-500 text-sm lg:text-lg font-medium">{item.desc}</p>
                                </div>
                            </div>
                    </>
                ))
            ...
            <div className="items-center justify-center text-center mt-4">
                <button className="bg-primary-500 p-4 rounded-xl text-white font-semibold items-start w-60 mt-4 hover:border-r-2 hover:border-b-2">Talk to Program Advisor</button>
            </div>
        </div>
    </>
  )
