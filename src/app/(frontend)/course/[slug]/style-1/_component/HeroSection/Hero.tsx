    ...
    <div className="bg-primary">
      <div className='container mx-auto grid grid-cols-2 gap-8 padding-y padding-x max-lg:gap-5 max-lg:grid-cols-1'>
        ...
        <div className=" text-background space-y-8 max-lg:space-y-0 max-lg:order-3">
          ...
          <Link href={'/enroll-now'} className="block"><Button className="text-bold bg-card text-primary-950 hover:bg-background max-md:hidden text-xl p-9 rounded-xl">Enroll For Free</Button></Link>
        </div>
        <section
