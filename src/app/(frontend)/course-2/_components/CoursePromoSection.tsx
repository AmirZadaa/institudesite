    ...
    <div style={{
      ...
      <div className='bg-foreground/70 bg-opacity-70 text-card padding-y padding-x max-sm:p-4 text-center space-y-8 font-semibold h-full'>
        ...
        <div className='space-x-4 space-y-4 items-center mx-auto'>
          <Button className='p-6 text-lg font-semibold hover:bg-primary-400 shadow-[5px_5px_0px_hsl(var(--primary-400))] hover:shadow-[5px_5px_0px_hsl(var(--primary-500))]'>Enroll me now <ChevronsRight strokeWidth={4} /></Button>
