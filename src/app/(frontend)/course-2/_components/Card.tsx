...
function CardContent({ data }) {
    ...
    return (
        <div className={`min-w-56 p-2 border-2 border-primary-400 border-dashed rounded-lg  space-y-8 hover:shadow-2xl shadow-primary-400 pb-4 ${isActive ? 'bg-primary-400 text-card' : 'bg-card'}`}>
