...
import RanaAjmal from '@/app/(frontend)/_assets/images/Rana-Ajmal.png'
    ...
    return (
        <div className='flex bg-card border relative rounded-xl w-full shadow-md p-4 max-sm:p-2 gap-4 max-sm:gap-2'>
            <div className='relative aspect-square w-24 max-sm:w-16'>
                <Image
                src={instructor.profileImage.url || RanaAjmal}
                    alt='instructor'
                    fill
            ...
            <div className='my-auto'>
                <h1 className='text-2xl max-sm:text-xl font-semibold'>{instructor.name}</h1>
                <p className='text-lg max-sm:text-base text-gray-500'>Instructor</p>
            </div>
            <div className='flex right-0 absolute gap-3 max-sm:gap-1 pr-4 max-sm:pr-1'>
                <LinkedinIcon size={20} strokeWidth={0.5} className='stroke-white fill-white bg-blue-500 max-sm:size-4 rounded-lg'/>
